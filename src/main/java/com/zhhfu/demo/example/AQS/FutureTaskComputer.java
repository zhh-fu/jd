...
public class FutureTaskComputer {
    public static void main(String[] args) {

        FutureTaskComputer inst=new FutureTaskComputer();
        // 创建任务集合
        ...
        for (int i = 0; i < 10; i++) {
            ...
            FutureTask<Integer> ft =
                    new FutureTask<Integer>(inst.new ComputeTask(i, ""+i));
            taskList.add(ft);
            // 提交给线程池执行任务，
            //也可以通过exec.invokeAll(taskList)一次性提交所有任务;
            exec.submit(ft);
        }
